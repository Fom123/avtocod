...
from avtocod.exceptions import SessionExpired, PipelineException
...
class ReLoginMiddleware(BaseRequestMiddleware):
    ...
    async def __call__(
        ...
        async def relogin() -> None:
            ...
            logger.info(f"Successfully got login and password, logging in")
        ...
        try:
            ...
            session_expired = [
                (index, r_or_e.avtocod_method) for index, r_or_e in enumerate(e.results_and_error)
